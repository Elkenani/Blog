...
class RouteServiceProvider extends ServiceProvider
{
    ...
    {
        Route::prefix('admin')//prefix is the word written in the URI before the route example /admin/post/create
        //but ofcourse now i will have to remove the "/admin" from my routes
            ->middleware('web')
            ->namespace($this->namespace)
